...
\begin{equation}
	\mathcal{S} = \{x_1, x_2, \dots, \chi_n\}, \quad n < N \; ,
\end{equation}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{5_figures/chapter1/prediction_vs_inference.png}
    ...
    \label{fig:prediction_vs_inference1}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{5_figures/chapter1/estimators.png}
    \caption{Representation of the true / population mean value $\mu$, in black, accessble only through the computation of an expected value. In red, the sample / observed mean $\bar{x}$, computed as an estimator of the finite sample.}
