...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.8\textwidth}
        ...
        \caption{Representation of the one-sided \(p\)-value for the \(\chi^2\)-test, computed as the integral of the right tail of the distribution.}
    ...
    \begin{subfigure}{0.8\textwidth}
        ...
        \caption{Representation of the two-sided \(p\)-value for the \(\chi^2\)-test, computed as the integral of the right tail of the distribution.}
