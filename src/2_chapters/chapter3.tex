...
%         \centering
%         \includegraphics[width=0.6\textwidth]{5_figures/chapter1/clt_1.png}
%         \caption{The Central Limit Theorem 1}
%         \label{fig:clt1}
%     \end{subfigure}
...
%     \begin{subfigure}{0.8\textwidth}
%         \centering
%         \includegraphics[width=0.6\textwidth]{5_figures/chapter1/clt_2.png}
%         \caption{The Central Limit Theorem 2}
%         \label{fig:clt2}
%     \end{subfigure}
...
%     \begin{subfigure}{0.8\textwidth}
%         \centering
%         \includegraphics[width=0.6\textwidth]{5_figures/chapter1/clt_3.png}
%         \caption{The Central Limit Theorem 3}
%         \label{fig:clt3}
%     \end{subfigure}
...
%     \begin{subfigure}{0.8\textwidth}
%         \centering
%         \includegraphics[width=0.6\textwidth]{5_figures/chapter1/xbar_sampling_distribution.png}
%         \caption{Sample mean distribution}
...
%     \begin{subfigure}{0.8\textwidth}
%         \centering
%         \includegraphics[width=0.6\textwidth]{5_figures/chapter1/confidence_intervals.png}
