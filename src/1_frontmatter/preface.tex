...
\begin{itemize}
    \item Chapter \ref{chapter1}: The Statistical theory of sampling, data types, estimators of central tendency and variation, and data visualization.
    \item Chapter \ref{chapter2}: Fundamentals of probability theory and random variables. Discrete and continuous events, cumulative probabilities, the idea of expected value.
    \item Chapter \ref{chapter3}: Estimation and confidence. The Law of Large Numbers, the Central Limit Theorem, confidence intervals and critical regions.
    \item Chapter \ref{chapter4}: Introduction to hypothesis testing. The modern Pearon-Neyman approach, statistical tests, parametric and non-parametric examples. 
