...
data_2 = np.random.normal(loc=0.5, scale=1.2, size=100)
data_2 = np.append(data_2, [5, 6, -4])  # add outliers
...
ax.grid(True, linestyle='--', alpha=0.3)
plt.tight_layout()
fig.savefig("histogram1_bins_large.png", dpi=300, bbox_inches='tight')
fig.savefig("histogram1_bins_large.pdf", bbox_inches='tight')
plt.show()
plt.close()
...
ax.grid(True, linestyle='--', alpha=0.3)
plt.tight_layout()
fig.savefig("histogram1_bins_small.png", dpi=300, bbox_inches='tight')
fig.savefig("histogram1_bins_small.pdf", bbox_inches='tight')
plt.show()
plt.close()
...
ax.grid(True, linestyle='--', alpha=0.3)
plt.tight_layout()
fig.savefig("histogram2_bins_large.png", dpi=300, bbox_inches='tight')
fig.savefig("histogram2_bins_large.pdf", bbox_inches='tight')
plt.show()
plt.close()
...
ax.grid(True, linestyle='--', alpha=0.3)
plt.tight_layout()
fig.savefig("histogram2_bins_small.png", dpi=300, bbox_inches='tight')
fig.savefig("histogram2_bins_small.pdf", bbox_inches='tight')
plt.show()
plt.close()