...
\begin{titlepage}
    ...
    \includegraphics[width=0.5\textwidth]{5_figures/frontpage/icl_logo.jpeg} 
    \vfill
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/histogram_1.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/histogram_2.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/histogram1_bins_small.png}
        \caption{Clean Gaussian distribution, no outliers.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/histogram2_bins_small.png}
        \caption{Skewed Gaussian due to outlier data.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/histogram1_bins_large.png}
        \caption{Clean Gaussian distribution, no outliers.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/histogram2_bins_large.png}
        \caption{Skewed Gaussian due to outlier data.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/box_1.png}
        \caption{Clean Gaussian distribution, no outliers.}
        \label{fig:box1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/box_2.png}
        \caption{Skewed Gaussian due to outlier data.}
        \label{fig:box2}
    \end{subfigure}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/violin_1.png}
        \caption{Clean Gaussian distribution, no outliers.}
        \label{fig:violin1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter1/violin_2.png}
        \caption{Skewed Gaussian due to outlier data.}
        \label{fig:violin2}
    \end{subfigure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{5_figures/chapter1/linear1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{5_figures/chapter1/quadratic1.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/bernoulli_1.png}
        \caption{Coin toss.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/bernoulli_2.png}
        \caption{Dice roll.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/binomial_1.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/binomial_1_cum.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/poisson_1.png}
        \caption{Probability of single event $\mathbb{P} (X = k)$.}
        \label{fig:poisson1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/poisson_1_cum.png}
        \caption{Cumulative probability $\mathbb{P} (X = k)$.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/duniform_1.png}
        \caption{Probability of single event $\mathbb{P} (X = k)$.}
        \label{fig:uniform1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/duniform_1_cum.png}
        \caption{Cumulative probability $\mathbb{P} (X > k)$.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/uniform_1.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/uniform_2.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/exponential_1.png}
        \caption{Probability density $f(x)$.}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/exponential_2.png}
        \caption{Cumulative probability $\int_a^b f(x) \, dx$.}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/gaussian_1.png}
        \caption{Probability density $f(x)$.}
        \label{fig:gaussian1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=0.7\textwidth]{5_figures/chapter2/gaussian_2.png}
        \caption{Cumulative probability $\int_a^b f(x) \, dx$.}
        \label{fig:gaussian2}
    \end{subfigure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter2/gaussian_2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{5_figures/chapter4/probability_vs_statistics.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter4/t_test_1_sample_p_one_tailed.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter4/t_test_1_sample_p_two_tailed.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter4/f_test_one_tailed.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter4/f_test_two_tailed.png}
    \caption{Representation of the F statistic, following the Fisher distribution, for a particular value of the degrees of freedom ($\nu = 10$). The integral of the shadowed area represents the \textit{2-sided}, or \textit{2-tailed} p-value, as the probability of obtaining a result \textit{at least as extreme} as the one obtained $t_{obs}$.}
    \label{fig:f_test2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter4/chi2_test_one_tailed.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/chapter4/chi2_test_two_tailed.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/appendix/functions_point_1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/appendix/functions_point_2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/appendix/functions_point_2_shadow.png}
    \caption{Representation of a function $f(x)$, a given point $x_0$ and its image $f(x_0)$, and an increment $\Delta x$ from $x_0$ to $x_0 + \Delta x$. The ratio between the increments in the horizontal axis, $\Delta x$, and the vertical axis $f(x_0 + \Delta x) - f(x_0)$ represents the derivative of the function at that point, that we denote by $f'(x_0)$.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/appendix/integrals_1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/appendix/integrals_2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/appendix/integrals_2_subdivisions.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{5_figures/appendix/integrals_3_riemann.png}
    \caption{Representation of a function $f(x)$, a given point $x_0$ and its image $f(x_0)$, and an increment $\Delta x$ from $x_0$ to $x_0 + \Delta x$. Here we divide the $\Delta x$ increment in smaller steps, aiming to approximate the area under the function. As the subdivisions become smaller, they become a better approximation of the area, and in the limit $\Delta x \rightarrow \infty$ they converge to the Riemann definition.}
